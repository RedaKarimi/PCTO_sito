    ...
    <Layout className="elements">
      <Content className="content">
            ...
            >
              ...
              <div key="b" className="imgAndText2 ">
                ...
                <div class="leftElements">
                  ...
                  <br /><button class="bottonePolo" onClick={()=>{navigate('/men'); window.scrollTo({top: 0, left: 0, behavior: 'smooth'});} }>Acquista subito</button>
                </div>
              </div>
            </QueueAnim>
          </OverPack>
        ...
        <div class="contenitore">
          <a onClick={() => { navigate('/children'); window.scrollTo({top: 0, left: 0, behavior: 'smooth'});}}><img src={require("./img/kids.jpg")} class="image1" /><p class="carousel" >CHILDREN STYLE</p></a>
          <a onClick={() => { navigate('/men'); window.scrollTo({top: 0, left: 0, behavior: 'smooth'});}}><img src={require("./img/model3.jpg")} class="image2" /><p class="carousel"> POLO & LUXURY</p></a>
        </div>
