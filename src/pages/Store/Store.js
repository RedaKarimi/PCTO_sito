...
function Store() {
  ...
  return (
    <Layout style={{ marginTop: 100 }}>
      ...
      <FloatButton style={{position:"absolute",right:"92%",top:"80%"}} icon={<ExclamationCircleOutlined />} tooltip={<div placement="right">Disclaimer: This 3D model is for style combination demonstration purposes only and does not reflect reality.
